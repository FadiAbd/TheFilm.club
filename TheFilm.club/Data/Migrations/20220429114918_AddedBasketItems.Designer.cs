...
namespace TheFilm.club.Data.Migrations
{
    ...
    [Migration("20220429114918_AddedBasketItems")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheFilm.club.Models.CustomerOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheFilm.club.Models.Theater", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheFilm.club.Models.CustomerOrderItem", b =>
                {
                    b.HasOne("TheFilm.club.Models.CustomerOrder", "CustomerOrder")
            ...
            modelBuilder.Entity("TheFilm.club.Models.Film", b =>
                {
                    b.HasOne("TheFilm.club.Models.Maker", "Maker")
                        .WithMany("Films")
                        .HasForeignKey("MakerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheFilm.club.Models.Theater", "Theater")
                        .WithMany("Films")
